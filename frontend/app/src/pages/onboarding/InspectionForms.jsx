      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-[#202A60] p-8 rounded-xl space-y-6">
          <div className="relative">
            ...
            />
            <i className="fa fa-bookmark absolute right-3 top-1/2 transform -translate-y-0/20 text-yellow-400"></i>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full p-3 pr-10 rounded-lg bg-[#1A235A] border border-gray-500 text-white"
            />
            <i className="fa fa-star absolute right-3 top-1/2 transform -translate-y-0/20 text-yellow-400"></i>
          </div>

          <div className="relative">
            <label className="block mb-1 text-gray-300">Année</label>
            <input
              type="number"
              placeholder="2007"
              className="w-full p-3 pr-10 rounded-lg bg-[#1A235A] border border-gray-500 text-white"
            />
            <i className="fa fa-calendar-alt absolute right-3 top-1/2 transform -translate-y-0/20 text-yellow-400"></i>
          </div>
