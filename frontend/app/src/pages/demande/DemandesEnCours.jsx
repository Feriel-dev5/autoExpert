...
const demandes = [
  {
    ...
    lien: "https://www.google.com/search?q=about+us+mobile+ui",
    date: "12 / 12 / 2021",
  },
  {
    id: 2,
      ...
      <aside className="w-64 bg-white shadow h-screen px-6 py-6 flex flex-col justify-between">
        <div>
          ...
          <nav className="space-y-6 text-gray-700">
            <div className="flex items-center gap-2 cursor-pointer hover:text-blue-700"  onClick={() => navigate("/modifier-profil")} >
              <FaUser />
              <span>Modifier Profil</span>
            </div>
            <div className="flex items-center gap-2 cursor-pointer hover:text-blue-700"  onClick={() => navigate("/securite")}>
              <FaLock />
              <span>Sécurité</span>
            </div>
          ...
          <div className="flex justify-end">
            <div className="relative">
              <button
                ...
                className="bg-orange-200 text-orange-700 px-4 py-1 rounded-md text-sm"
              >
                ⏱ En cours
              </button>
              {menuOpen && (
                <div className="absolute right-0 mt-1 bg-white shadow rounded-md w-40 z-10 text-sm">
                  ...
                  <div className="py-2 px-4 hover:bg-gray-100 cursor-pointer text-red-500"  onClick={() => navigate("/demandes-annulees")}>
