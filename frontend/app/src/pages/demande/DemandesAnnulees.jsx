        ...
        <main className="px-10 pb-10 space-y-5">
          {demandes.map((d) => (
            <div key={d.id} className="bg-white p-6 rounded-xl shadow space-y-2">
              <p className="text-red-600 font-semibold text-sm">Demande annulées</p>
              ...
              <div className="flex justify-between items-center pt-2">
                ...
                <FaTrash className="text-blue-600 cursor-pointer" />
              </div>
            </div>
          ))}
        </main>
...
export default DemandesAnnulees;